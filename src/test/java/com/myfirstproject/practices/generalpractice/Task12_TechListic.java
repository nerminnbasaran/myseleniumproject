...
public class Task12_TechListic extends TestBase {
...
//        Calculate min year
        int minYear = years.stream().distinct().reduce(Integer.MAX_VALUE, (t,u)->t<u ? t : u);
...
//        Assert that build height is 25.45 meters
        Assert.assertEquals("25.45", formattedValue);
    }
}